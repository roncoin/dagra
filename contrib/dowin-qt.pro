...
RESOURCES += src/qt/dowin.qrc src/qt/dowin_locale.qrc
TRANSLATIONS += src/qt/locale/dowin_bg.ts \
                src/qt/locale/dowin_de.ts \
                src/qt/locale/dowin_en.ts \
                src/qt/locale/dowin_es.ts \
                src/qt/locale/dowin_fi.ts \
                src/qt/locale/dowin_fr.ts \
                src/qt/locale/dowin_it.ts \
                src/qt/locale/dowin_ja.ts \
                src/qt/locale/dowin_pl.ts \
                src/qt/locale/dowin_pt.ts \
                src/qt/locale/dowin_ru.ts \
                src/qt/locale/dowin_sk.ts \
                src/qt/locale/dowin_sv.ts \
                src/qt/locale/dowin_vi.ts \
                src/qt/locale/dowin_zh_CN.ts \
                src/qt/locale/dowin_zh_TW.ts
