...
2. [Sending 1,000 DAGRA to new wallet addresses.](#option2)
...
### Send 1,000 DAGRA to New Addresses

Just like setting up a standard MN. Send exactly 1,000 DAGRA to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1K DAGRA.

The masternode private key may be an existing key from [Option 1](#option1), or a newly generated key from [Option 2](#option2). 

*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 1,000 DAGRA on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the dagra github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
## What about the dagra.conf file?

If you are using a masternode.conf file you no longer need the dagra.conf file. The exception is if you need custom settings (thanks oblox). 

## Update dagra.conf on server

If you generated a new masternode private key, you will need to update the remote dagra.conf files.

Shut down the daemon and then edit the file.

```sudo nano .dagra/dagra.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote dagra.conf file.
