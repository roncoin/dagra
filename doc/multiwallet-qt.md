...
Only requiring some minor changes is dowin.cpp.
...
Changes to dowin.cpp
----------------------
dowin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
