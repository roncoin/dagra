...
Only requiring some minor changes is dagra.cpp.
...
Changes to dagra.cpp
----------------------
dagra.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
