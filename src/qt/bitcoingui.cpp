    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dowin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dowin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dowin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dowin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dowin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dowin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dowin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dowin addresses"));
    ...
    openAction->setStatusTip(tr("Open a dowin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dowin Core help message to get a list with possible Dowin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dowin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dowin network", "", count));
}
...
{
    QString strTitle = tr("Dowin Core"); // default title
