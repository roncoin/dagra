    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dagra Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dagra address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dagra: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dagra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dagra Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dagra"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dagra addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dagra addresses"));
    ...
    openAction->setStatusTip(tr("Open a dagra: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dagra Core help message to get a list with possible Dagra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dagra Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dagra network", "", count));
}
...
{
    QString strTitle = tr("Dagra Core"); // default title
