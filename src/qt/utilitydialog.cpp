    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dagra Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Dagra Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dagra-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dagra Core is shutting down...") + "<br /><br />" +
