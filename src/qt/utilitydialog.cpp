    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dowin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Dowin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dowin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dowin Core is shutting down...") + "<br /><br />" +
