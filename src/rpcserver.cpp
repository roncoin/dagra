...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Dowin features */
    { "dowin",               "masternode",             &masternode,             true,      true,       false },
    { "dowin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "dowin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "dowin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "dowin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "dowin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "dowin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "dowin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use dowind, or the -server option to dowin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> dowin-cli " + methodname + " " + args + "\n";
}
